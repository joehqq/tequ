<template>
	<view class="u-upload" v-if="!disabled">
		...
		<view style="display: inline-block; width: 100%;" @tap="selectFile" v-if="maxCount > lists.length">
			...
			>
				<u-icon name="plus" class="u-add-btn clas" size="40"></u-icon>
				<!-- <view class="u-add-btn">
					点击上传
				</view> -->
