 ...
 * post网络请求 
 */
const basePost = function(url, data, successCallback, errorCallback, wantCheck, isWeixin, header) {
	if (wantCheck) {
		if (requestMap[url]) {
 ...
 * get网络请求 
 */
const baseGet = function(url, data, successCallback, errorCallback, wantCheck, isWeixin, header) {
	if (wantCheck) {
		if (requestMap[url]) {
